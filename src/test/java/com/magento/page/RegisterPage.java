...
public class RegisterPage extends BasePage{
    ...
    //no se esta usando este por el  momento
    ...
    public void createAccount() {
        type(firstname, "carla");
        type(lastname, "arevilca");
        type(email, "carla.r@gmail.com");
        type(password, "Guitarra3151!!!");
        type(confirm, "Guitarra3151!!!");
